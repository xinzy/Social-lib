...
public class Platform {
	...
	// Sina 微博
	public static String WEIBO_KEY = "1108795777";
	public static String WEIBO_SECRET = "bb38a46a0bbd41c90a1b82c61c24073d";
	public static String WEIBO_REDIRECT_URL = "http://www.gaodun.com/oauth/weibo/callback.php";

	// QQ
	public static String QQ_APPID = "101055478";
	public static String QQ_APPKEY = "a15192b69926e129f53c1f12942f833a";
	public static final String QQ_SCOPE = "get_user_info";

	// 微信
	public static String WECHAT_APPID = "wx8baf1de2a92d60c4";
